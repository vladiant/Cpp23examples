...
//
// https://godbolt.org/z/PM7h6WevW
// GCC 13.1 -std=c++23 -lstdc++_libbacktrace
...
void do_session(beast::tcp_stream& stream, asio::yield_context yield) {
...
int main(int argc, char* argv[]) {
  ...
  for (auto i = num_threads - 1; i; --i) v.emplace_back([&ioc] { ioc.run(); });
